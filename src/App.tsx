        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group p-8 border border-slate-100 rounded-3xl hover:border-blue-500 transition-all bg-slate-50 hover:bg-white hover:shadow-2xl">
              <div className="w-12 h-12 bg-blue-600 text-white rounded-lg flex items-center justify-center mb-6 font-bold uppercase text-xs">MEP</div>
            ...
            <div className="group p-8 border border-slate-100 rounded-3xl hover:border-blue-500 transition-all bg-slate-50 hover:bg-white hover:shadow-2xl">
              <div className="w-12 h-12 bg-blue-600 text-white rounded-lg flex items-center justify-center mb-6 font-bold uppercase text-xs">VDC</div>
            ...
            <div className="group p-8 border border-slate-100 rounded-3xl hover:border-blue-500 transition-all bg-slate-50 hover:bg-white hover:shadow-2xl">
              <div className="w-12 h-12 bg-blue-600 text-white rounded-lg flex items-center justify-center mb-6 font-bold uppercase text-xs">SCAN</div>
