      ...
      <section onMouseMove={handleMouseMove} className="relative min-h-[90vh] flex items-center justify-center bg-slate-950 overflow-hidden pt-24 pb-16 px-6 group">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            {/* SYMMETRICAL GLASS BUTTON 1 */}
            <a 
              href="#portfolio" 
              className="w-64 bg-white/5 text-white py-4 rounded-lg font-bold text-xs uppercase tracking-widest border border-white/10 hover:bg-white/10 hover:border-blue-400/50 transition-all shadow-lg backdrop-blur-sm text-center"
            >
              View Portfolio
            </a>

            {/* SYMMETRICAL GLASS BUTTON 2 */}
            <a 
